                ...
                <div class='card-body'>
                    ...
                    <form action='{{ route('product.update',$edit->id) }}' method='post' enctype='multipart/form-data'>
                        ...
                        <div class='mb-3'>
                            ...
                            <input type='text' value='{{ $edit->product_name}}'class='form-control' name='product_name' placeholder='Enter Product Name' required>
                        </div>
                        <div class='mb-3'>
                        ...
                        <div class='mb-3'>
                            ...
                            <input type='number' value='{{ $edit->product_price}}'class='form-control' name='product_price' placeholder='Enter Product Price' required>
                        </div>
                        <div class='mb-3'>
                            <label for='' class='col-form-label'>Product Description *</label>
                            <input type='text' value='{{ $edit->product_description}}' class='form-control' name='product_description' placeholder='Enter Product Description' required>
                        </div>
                        <div class='mb-3'>
                            <label for='' class='col-form-label'>Product Photo *</label>
                            <div class='m-3'>
                                @if ($edit->product_photo)
                                <img src="{{ asset('storage/'.$edit->product_photo) }}" alt="{{ $edit->product_name }}" width="100">
                                @else
                                <img src="" alt="{{ $edit->product_name }}" width="100">

                                @endif
                            </div>
                            <input type='file' class='form-control' name='product_photo' placeholder='Enter Product Photo' required>
                        </div>
                        <div class='mb-3'>
